...
export const render_worker_band_row_offset: () => number;
export const render_worker_draw_band: (a: number, b: number) => [number, number];
export const render_worker_init: (a: number, b: number, c: number, d: number) => void;
export const render_worker_telemetry: () => [number, number];
export const render_worker_upload_atlas: (a: number, b: number) => void;
export const render_worker_upload_atlas_rows: (a: number, b: number, c: number) => number;
...
export const set_render_worker_count: (a: number) => void;
